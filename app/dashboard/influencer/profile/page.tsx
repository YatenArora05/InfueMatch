      ...
      <div className="bg-white rounded-2xl md:rounded-[3rem] border border-gray-100 p-4 md:p-8 lg:p-12 shadow-2xl shadow-purple-50 flex-1 overflow-y-auto">
        ...
        <form className="space-y-6 md:space-y-10" onSubmit={async (e) => {
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              <input type="text" name="estimatedRate" placeholder="e.g., $500 - $1000, $1k - $2k, or $5k+" className="w-full pl-10 md:pl-12 pr-4 py-3 md:py-4 bg-gray-50 border-none rounded-xl md:rounded-2xl focus:ring-2 focus:ring-purple-600 outline-none text-sm md:text-base" />
            ...
            <p className="text-[10px] md:text-xs text-gray-500 ml-1">Approximate rate range you&apos;re willing to work with brands (optional)</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
            ...
            <button
              ...
              className={`flex-1 py-4 md:py-5 text-lg md:text-xl font-semibold rounded-xl transition-all duration-200 active:scale-95 ${
                hasBeenSaved && !isSaving ? 'bg-purple-600 text-white hover:bg-purple-700 hover:shadow-lg hover:shadow-purple-200 cursor-pointer' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
              }`}
            >
