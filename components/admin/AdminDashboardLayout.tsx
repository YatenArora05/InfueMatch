...
import { Menu, Shield, Users, LogOut, KeyRound } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/access-control", label: "Access Control", icon: KeyRound },
];
    ...
    <div className="flex min-h-screen bg-[#020617] text-[#E5E7EB] relative overflow-hidden">
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, transparent 0%, rgba(2,6,23,0.6) 60%, rgba(2,6,23,1) 100%)",
          }}
        />
      </div>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#020617]/95 backdrop-blur-xl border-r border-[#1F2937] transform transition-transform duration-300 ease-in-out md:translate-x-0 ${
      ...
      <div className="flex-1 flex flex-col md:ml-64 relative z-10">
        ...
        <main className="p-4 md:p-8 overflow-y-auto w-full">{children}</main>
      </div>
    </div>
  );
}
