...
const accountNav = [{ name: "Profile", icon: User, href: "/dashboard/influencer/profile" }] as const;

function navIsActive(pathname: string, href: string) {
  if (href === "/dashboard/influencer") {
    return pathname === "/dashboard/influencer";
  }
    ...
    <Link
      ...
      className={`group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition-colors ${
        active
          ...
          : "text-[#E5E7EB] hover:bg-white/6"
      }`}
    >
      <item.icon
        size={18}
        strokeWidth={1.75}
        className={active ? "text-white" : "text-[#9CA3AF] group-hover:text-[#E5E7EB]"}
      />
    ...
    <>
        ...
        <SidebarShell className="w-full rounded-2xl shadow-xl shadow-black/40">
          ...
          <div className="space-y-1 px-3 py-4">
            ...
            <Link
              ...
              onClick={handleLinkClick}
              className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold text-[#E5E7EB] transition-colors hover:bg-white/6"
            >
      ...
      >
        <SidebarShell className="rounded-none border-l border-[#1e2228]">
          ...
          <div className="space-y-1 border-t border-[#1e2228] px-3 py-4">
            {userCard}
            <Link
              href="/dashboard/influencer/settings"
              onClick={handleLinkClick}
